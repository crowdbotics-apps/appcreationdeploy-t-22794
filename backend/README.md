...
## Project Structure
    ...
    ├── appcreationdeploy_t_22794  # Django project configurations
...
1. Clone this repo and `cd appcreationdeploy_t_22794`
...
2. Clone this repo and `cd appcreationdeploy_t_22794`
